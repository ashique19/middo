...
Package: `com.middo.delivery` · Display name: **Middo Delivery** (store can show **Middo Rider**) · Current version: **0.3.2 (12)**
...
Bump `version:` in `pubspec.yaml` before each Play upload (`0.3.2+12` → name `0.3.2`, code `12`).
