...
Package: `com.middo.kitchen` · Display name: **Middo Kitchen** · Current version: **0.3.1 (9)**
...
Bump `version:` in `pubspec.yaml` before each Play upload (`0.3.1+9` → name `0.3.1`, code `9`).
