...
class OrdersLastMonth extends Component
{
    ...
    {
        $kitchenId = Auth::id();
        $monthStart = Carbon::now('Asia/Dhaka')->subMonthNoOverflow()->startOfMonth()->toDateString();
        $monthEnd = Carbon::now('Asia/Dhaka')->subMonthNoOverflow()->endOfMonth()->toDateString();
        ...
        return OrdersExcelExport::download(
            $orders,
            'kitchen-orders-last-month-'.Carbon::parse($monthStart, 'Asia/Dhaka')->format('Y-m').'.csv',
            kitchenSafe: true
        );
    }
    ...
    public function render()
    {
        ...
        return view('livewire.kitchen.orders-last-month', [
            'groups' => $groups,
            'groupNodes' => $groupNodes,
            'flatOrders' => $flatOrders,
            'monthLabel' => Carbon::parse($monthStart, 'Asia/Dhaka')->format('F Y'),
        ])->layout('kitchen.layout.app', ['title' => 'Orders — Last Month']);
    }
}
