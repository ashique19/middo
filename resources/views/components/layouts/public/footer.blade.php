        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-12">
            ...
            <div class="space-y-4">
                ...
                <div class="flex gap-4">
                    <a href="https://facebook.com/middo" target="_blank" rel="noopener" class="text-gray-400 hover:text-[#C9621F] transition duration-300" aria-label="Middo on Facebook">
                    ...
                    <a href="https://linkedin.com/company/middo" target="_blank" rel="noopener" class="text-gray-400 hover:text-[#C9621F] transition duration-300" aria-label="Middo on LinkedIn">
