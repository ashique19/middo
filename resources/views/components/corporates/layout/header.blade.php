    ...
    <nav class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center relative">
        ...
        <div x-show="mobileMenuOpen"
             ...
             <div class="flex items-center gap-4 mb-6">
                 ...
                 <div>
                     ...
                     <p class="text-sm text-gray-500">Balance: 
                        ...
                        <a href="#" class="text-middo-orange" @click="mobileMenuOpen = false">(Add/Withdraw)</a>
                    </p>
                 </div>
             </div>
             ...
             <div class="space-y-6 flex flex-col items-start">
                 ...
                 <form action="{{ route('logout') }}" method="POST">
                     @csrf
                     <button type="submit" class="text-lg font-semibold text-middo-orange">Logout</button>
                 </form>
             </div>
        </div>
    </nav>
