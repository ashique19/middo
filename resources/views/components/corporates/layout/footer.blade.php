        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-400">
                    ...
                    <li><a href="#" class="hover:text-white transition">For Corporates</a></li>
                    <li><a href="#" class="hover:text-white transition">For Kitchens</a></li>
            ...
            <div>
                ...
                <ul class="space-y-3 text-gray-400">
                    ...
                    <li><a href="mailto:contact@middo.com" class="hover:text-white transition">Contact Us</a></li>
