...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 space-y-6">
    ...
    @if($tree)
        <div class="bg-white border border-gray-100 rounded-2xl p-5 shadow-sm space-y-5">
            <div class="flex flex-wrap items-start justify-between gap-3">
                <div>
                ...
                <a href="{{ route($this->rolePrefix().'.accounts.index') }}" class="text-xs font-bold text-middo-orange hover:underline">Accounts hub →</a>
            </div>
