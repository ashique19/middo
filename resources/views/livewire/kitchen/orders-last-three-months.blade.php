<div class="max-w-7xl mx-auto py-10 px-6 space-y-6">
    <div class="flex flex-wrap items-start justify-between gap-4">
        <div class="space-y-1">
            ...
            <h1 class="text-3xl font-bold text-middo-dark">Last 3 months</h1>
    ...
    @if($viewMode === 'list')
        <x-operation.orders.table :orders="$flatOrders" :show-group="true" empty-message="No orders in this range." />
        @if($groups->hasPages())
