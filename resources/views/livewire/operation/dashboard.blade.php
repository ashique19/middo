<div wire:key="operation-dashboard" class="max-w-7xl mx-auto py-10 px-6 space-y-8">
    <div class="space-y-1">
        <h1 class="text-3xl font-bold text-middo-dark">Dashboard Overview</h1>
        <p class="text-sm font-semibold text-gray-500">Quick links to operation areas.</p>
    </div>
