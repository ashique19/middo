<div>
    @if($showModal)
        <div wire:key="change-password-modal-root" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
            {{-- Backdrop --}}
            ...
            <div class="relative bg-white w-full max-w-md rounded-2xl shadow-2xl border border-[#EBE3D3] max-h-[90vh] overflow-y-auto">
                ...
                <div class="flex items-center justify-between p-5 border-b border-[#EBE3D3] sticky top-0 bg-white rounded-t-2xl">
                    <div>
                        <h2 class="text-xl font-black tracking-tight text-[#2B1A11]">Change Password</h2>
                        <p class="text-xs font-semibold text-[#635347] mt-0.5">Keep your account secure with a strong password.</p>
                    </div>
